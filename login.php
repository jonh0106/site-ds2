  ...
  <main role="main" class="container">
    ...
    <div class="row">
      <div class="col-sm-4 offset-sm-4 border shadow">
        ...
        <form action="valida-login.php" id="form-login" method="POST">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" name="email" class="form-control" placeholder="E-mail" aria-label="email" aria-describedby="basic-addon1"value="<?php echo @$dadosForm['email']; ?>">
          </div>
          ...
          <div class="input-group mb-3">
            ...
            <input type="password" name="senha" class="form-control" placeholder="Senha" aria-label="senha" aria-describedby="basic-addon1"value="<?php echo @$dadosForm['senha']; ?>">
          </div>
