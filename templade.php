        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item" href="https://getbootstrap.com.br/docs/4.1/examples/starter-template/#">Item</a>
              <a class="dropdown-item" href="https://getbootstrap.com.br/docs/4.1/examples/starter-template/#">Outro item</a>
              <a class="dropdown-item" href="https://getbootstrap.com.br/docs/4.1/examples/starter-template/#">Algum outro item</a>
            </div>
          </li>
        </ul>
